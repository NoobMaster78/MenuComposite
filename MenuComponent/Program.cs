...
namespace MenuComponent
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cafeMenu.add(new MenuItem("Burrito", "A large burrito, with whole pinto beans, salsa, guacomale", true, 4.29));

            dessertMenu.add(new MenuItem("Apple pie", "Apple pie with a flakey crust, topped with vanilla icecream", true, 120));
